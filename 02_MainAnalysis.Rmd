...
bigBoot_MM <- bootMer(fit_MM, myFunc, nsim = 1000, parallel = "multicore", ncpus = 4)
...
bigBoot_Nonattuned <- bootMer(fit_Nonattuned, myFunc, nsim = 1000, parallel = "multicore", ncpus = 4)
